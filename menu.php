        ...
        <ul class="sidebar-menu">
            ...
            <li>
                ...
                <ul class="submenu <?= ($cat == 'western' || $cat == 'eastern') ? 'show' : '' ?>">
                    <li>
                        <a href="menu.php?cat=western" class="sub-btn <?= $cat == 'western' ? 'active' : '' ?>">  Western Dessert </a>
                    </li>

                    <li>
                        <a href="menu.php?cat=eastern" class="sub-btn <?= $cat == 'eastern' ? 'active' : '' ?>"> Eastern Dessert </a>
                    </li>
                </ul>
            </li>
...
>>>>>>> 3003aec97fe925d3f9b3746a9345d14401ebfcb9
...
<div class="product-card" 
    ...
    <p> 
        <?= htmlspecialchars($item['description'] ?? 'Delicious item') ?> 
    </p> 
    <div class="price"> 
